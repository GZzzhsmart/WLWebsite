        ...
        <div class="ibox-content">
            ...
            <div id="toolbar" class="btn-group pull-right" style="margin-right: 20px;">
                <button id="btn_add" type="button" class="btn btn-default">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true" ></span><a a class="J_menuItem" style="color: white" href="<%=path%>/home/initAdd">新增媒体信息</a>
                </button>
            </div>
        </div>
    </div>
...
<script src="<%=path%>/static/js/media.js"></script>
</body>
</html>
